...
const OIDC_AUTH_URI = "https://discord.com/api/oauth2/authorize";
const OIDC_TOKEN_URI = "https://discord.com/api/oauth2/token";
const OIDC_USERINFO_URI = "https://discord.com/api/oauth2/@me";
